...
Route::get('/data/kelas', [SibaperController::class , 'kelas']);
Route::post('/data/Kelas/tambah', [KelasController::class , 'kelas']);

Route::get('/data/Dosen', [DosenController::class , 'dosen']);
Route::post('/data/Dosen/tambah', [DosenController::class , 'dosen']);
